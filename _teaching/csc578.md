...
- **Week 1: Introduction to Neural Networks**. [Slides](/assets/pdf/teaching/csc578/01_intro.pdf), [Video](#) 
...
- **Assignment 1: Python Basics and Multilayer Perceptron**  
  [Download Notebook](/assets/jupyter/assignment1.ipynb) | [Open in Colab](https://colab.research.google.com/github/yourusername/deeplearning-course/blob/main/assets/jupyter/assignment1.ipynb)
